  ...
  const authors = [
    {
      ...
      styles:
        "text-lg text-slate-600 md:col-start-2 md:row-start-1 flex flex-col aspect-[4/3] rounded-lg md:aspect-[3/4] xl:aspect-[4/3]",
    },
    {
      nama: "Naomi Prisella",
      ...
      styles:
        "text-lg text-slate-600 md:col-start-4 md:row-start-2 flex flex-col aspect-[4/3] rounded-lg md:aspect-[3/4] xl:aspect-[4/3]",
    },
    {
      ...
      styles:
        "text-lg text-slate-600 md:col-start-1 md:row-start-3 flex flex-col aspect-[4/3] rounded-lg md:aspect-[3/4] xl:aspect-[4/3]",
    },
  ];
