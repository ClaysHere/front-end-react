...
const Fruits = (props) => {
  ...
  return (
    <>
      <div
        className={"mb-24 mt-4 mx-8 grid grid-cols-1 md:grid-cols-2 gap-x-8"}>
        <p className={"col-start-1"}>{props.id}</p>
        ...
        <img
          ...
          alt={"gambar"}
        />
        <p className={"mt-4 lg:col-start-2 lg:row-start-3"}>{props.desk1}</p>
        <p className={"mt-4 lg:col-start-2 lg:row-start-4"}>{props.desk2}</p>
        <p className={"mt-4 lg:col-start-2 lg:row-start-5"}>{props.desk3}</p>
